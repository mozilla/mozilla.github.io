		...
		$.ajax({
		  	...
		  	success: function( data ) {
				if( data.length == 0 ){ stop = true; }
		  		...
		  		for (var j = 0, html = ''; j < data.length; j++) {
		  			html = '<a href="' + data[j].html_url + '" target="_blank">' + data[j].full_name + ' <span>' + data[j].stargazers_count + '</span></a>'
